...
def stringToInteger():
    ...
    print('\nChanging data type', type(string0), 'to', type(int(string0))) # conversion
...
def characterToInteger():
    ...
    print('\nChanging data type', type(char0), 'to', type(ord(char0))) # conversion
...
def integerToCharacter():
    ...
    print('\nChanging data type', type(int0), 'to', type(chr(int0))) # conversion
...
def floatToInteger():
    ...
    print('\nChanging data type', type(float0), 'to', type(int(float0))) # conversion
